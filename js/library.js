console.log("This is Anna's library");
showBooks();
...
function libraryFormSubmit(e) {
    ...
    e.preventDefault();
    // this will prevent the page from reloading itself automatically right after we click on submit, so that console doesnt get refreshed
